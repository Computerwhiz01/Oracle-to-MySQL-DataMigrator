::Test name: Oracle_QueryFile Limit10
	::Description:	Read SQL from a query file "c:\Python27\data_migrator_1239\test\v101\query\oracle_query.sql".Copy only 10 rows from Oracle query results into MySQL table.
	::Arguments:
