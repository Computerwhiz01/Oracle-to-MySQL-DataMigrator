::Test name: Oracle_QueryDir Limit10
	::Description:	Read each SQL query file from a directory "c:\Python27\data_migrator_1239\test\v101\query\query_dir_ora".Copy only 10 rows from Oracle query results into MySQL table.
	::Arguments:
...
echo y|c:\Python27\dm_dist_32\20141212_112917\dm32\dm32.exe ^
-w ora2mysql ^
-o 1 ^
-r 1 ^
-t "|" ^
